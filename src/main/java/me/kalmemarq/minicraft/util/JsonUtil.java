...
public class JsonUtil {
    ...
    public static short getShort(JsonObject obj, String key) {
        return hasNumber(obj, key) ? obj.get(key).getAsShort() : 0;
    }
    ...
    public static int getInt(JsonObject obj, String key) {
        return hasNumber(obj, key) ? obj.get(key).getAsInt() : 0;
    }
    ...
    public static long getLong(JsonObject obj, String key) {
        return hasNumber(obj, key) ? obj.get(key).getAsLong() : 0;
    }
    ...
    public static boolean getBoolean(JsonObject obj, String key) {
        return hasBoolean(obj, key) ? obj.get(key).getAsBoolean() : false;
    }
